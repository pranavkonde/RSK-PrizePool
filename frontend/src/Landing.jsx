  ...
  return (
    <div className="landing">
      <nav className="landing-nav">
        ...
        <button type="button" onClick={onEnter} className="btn btn-primary btn-nav">
          Launch App
        </button>
      </nav>
      ...
      <main>
        <section className="landing-hero">
          ...
          <button type="button" onClick={onEnter} className="btn btn-primary btn-hero">
            Get Started
          </button>
        </section>
        ...
        <section className="landing-cta">
          ...
          <button type="button" onClick={onEnter} className="btn btn-primary btn-cta">
            Launch App
          </button>
        </section>
      </main>
